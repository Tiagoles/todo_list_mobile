...
part of 'inspecao_completing_viewmodel.dart';
...
mixin _$InspecaoCompletingViewModel on InspecaoCompletingViewModelBase, Store {
  late final _$modelsAtom = Atom(
    name: 'InspecaoCompletingViewModelBase.models',
    context: context,
  );
