...
part of 'inspecao_returning_viewmodel.dart';
...
mixin _$InspecaoReturningViewModel on InspecaoReturningViewModelBase, Store {
  late final _$modelsAtom = Atom(
    name: 'InspecaoReturningViewModelBase.models',
    context: context,
  );
