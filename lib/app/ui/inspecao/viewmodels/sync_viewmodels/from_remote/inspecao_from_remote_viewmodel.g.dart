...
part of 'inspecao_from_remote_viewmodel.dart';
...
mixin _$InspecaoFromRemoteViewModel on InspecaoFromRemoteViewModelBase, Store {
  late final _$modelsAtom = Atom(
    name: 'InspecaoFromRemoteViewModelBase.models',
    context: context,
  );
